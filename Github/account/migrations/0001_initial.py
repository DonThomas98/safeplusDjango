# Generated by Django 3.1.2 on 2020-11-06 06:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_material', models.ManyToManyField(to='account.MaterialCapacitaciones')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_Materialsolicitado', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='account.materialsolicitado')),
                ('rut_cliente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='capacitaciontrabajador', to='account.userprofile')),
                ('rut_trabajador', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='capacitacioncliente', to='account.userprofile')),
            ],
            options={
